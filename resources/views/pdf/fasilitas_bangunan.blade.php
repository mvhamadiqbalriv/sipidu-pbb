...
<body>
    <table class="center">
        <tbody>
            <tr>
                <td style="padding-bottom:10px;"><img src="{{asset('assets/images/sumedang.png')}}" width="50px;" alt=""></td>
                <td colspan="4" style="padding-bottom:10px;"><h3>PERHITUNGAN FORMULIR FASILITAS BANGUNAN</h3></td>
            </tr>
            <tr>
                <td class="border-tl"><b>Nomor Objek Pajak</b></td>
                <td class="border-tr" colspan="4"><b>: {{$detail->objek_pajak->nop}}</b></td>
            </tr>
        ...
        <tr>
            <th style="padding-top:10px;">I. AC CENTRAL JPB</th>
        ...
        <tr>
            <th colspan="2">VIII. Sumur artesis</th>
        ...
        <tr>
            <th colspan="2">IX. Sistem air panas</th>
        ...
        <tr>
            <th colspan="2">X. Penangkal petir</th>
        ...
        <tr>
            <th colspan="2">XI. Sistem pengolahan limbah</th>
        ...
        <tr>
            <th colspan="2">XII. Sistem tata suara</th>
        ...
        <tr>
            <th colspan="2">XIII. Video intercom</th>
